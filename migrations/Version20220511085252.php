 ...
 */
final class Version20220511085252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD user_id INT DEFAULT NULL, ADD created_by VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP user_id, DROP created_by');
    }
}
